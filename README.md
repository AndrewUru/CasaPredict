...
![Interfaz de la aplicación](https://via.placeholder.com/800x400.png?text=Interfaz+de+Predicción+Precio+Vivienda)  
_Ejemplo de la interfaz mostrando la selección de la comunidad autónoma "Cantabria" y el precio estimado devuelto por el sistema (1508.37 €)._
